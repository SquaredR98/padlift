...
export function FaqWithCtaStatic({ branding, content, styles }: BlockComponentProps) {
    ...
    >
      <div className={cn('mx-auto', tokens.maxWidth)}>
        ...
        <div className="mt-12 space-y-0 divide-y divide-[var(--lp-site-border)]">
          {faqs.map((faq, i) => (
            <details key={i} className="group py-5">
              <summary className="flex cursor-pointer items-center justify-between text-base font-medium text-[var(--lp-site-heading)]">
                {faq.question}
        ...
        >
          ...
          <a
            href={ctaUrl}
            className="mt-6 inline-block rounded-xl bg-white px-8 py-3 text-sm font-semibold"
